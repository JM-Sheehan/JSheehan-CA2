...
sf::Vector2f SpriteCmpt::getPosition() {
    return m_sprite.getPosition();
}

sf::Vector2f SpriteCmpt::getSize() {
    auto vector =  sf::Vector2f(m_sprite.getGlobalBounds().width, m_sprite.getGlobalBounds().height);
    return vector;
}