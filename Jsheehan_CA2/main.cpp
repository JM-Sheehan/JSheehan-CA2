...
int main(int, char const**)
{
    ...
    player.AttachComponent<CollideCmpt>();
    player.GetComponent<ReadableInfoCMPT>()->addComponentDetails("CollideCmpt");

    auto colcmpt = player.GetComponent<CollideCmpt>();
    colcmpt->setPos(sprcmpt->getPosition());
    colcmpt->setSize(sprcmpt->getSize());
